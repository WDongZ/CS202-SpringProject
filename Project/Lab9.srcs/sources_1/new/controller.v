module controller(
    inst,MemRead,ALUOp,Branch,ALUsrc,MemWrite,MemtoReg,RegWrite, Alu_resultHigh,MemorIOtoReg,IORead,IOWrite,jal
    );
    input[21:0] Alu_resultHigh; 
    output reg [1:0] ALUOp;
    input [31:0]inst;
    output MemRead,Branch,ALUsrc,MemWrite,MemtoReg,RegWrite,MemorIOtoReg,MemRead,IORead,IOWrite,jal;
    ...
    assign MemWrite = ((sw==1) && IOWrite == 0 && Alu_resultHigh != 0) ? 1'b1:1'b0;  
